...
int32_t main()
{
    ...
    for(auto [x,y]: mprime){
        ...
        // we can do the knapsack such that is included or not 
        // if it is included then it is 
        // from dp[i][0]....dp[i][need] me inv_fact[its_cnt-1] se multiply karke inko update kar denge
        // else exclude rakhnge  
