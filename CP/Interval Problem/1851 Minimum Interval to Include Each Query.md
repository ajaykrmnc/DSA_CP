...
**LeetCode:** [1851. Minimum Interval to Include Each
Query](https://leetcode.com/problems/minimum-interval-to-include-each-query/) **Difficulty:** Hard **Pattern:**
Offline heap **Tags:** Array, Binary Search, Sweep Line, Sorting, Heap (Priority Queue)
...
Sort intervals by start and queries by value. Push intervals whose start is valid into a min-heap by length, and remove
intervals whose end is before the query.
