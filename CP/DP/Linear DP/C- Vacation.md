...
**Problem Statement:**
Taro's summer vacation lasts for N days. For each day i (1 ≤ i ≤ N), he can choose to do one of three activities: A, B,
or C. Each activity gives him happiness points: a[i], b[i], or c[i] respectively on day i. However, he cannot do the
