...
Binary search the cut position in the smaller array. The correct partition has every left-side value less than or equal to every right-side value, then the median comes from the boundary values.
