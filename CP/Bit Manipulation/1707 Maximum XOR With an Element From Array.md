...
**LeetCode:** [1707. Maximum XOR With an Element From
Array](https://leetcode.com/problems/maximum-xor-with-an-element-from-array/) **Difficulty:** Hard **Pattern:**
Offline trie **Tags:** Array, Bit Manipulation, Trie
...
Sort numbers and queries by `m`. Insert eligible numbers into a binary trie, then greedily walk opposite bits to
