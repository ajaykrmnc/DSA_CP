...
**LeetCode:** [2472. Maximum Number of Non-overlapping Palindrome
Substrings](https://leetcode.com/problems/maximum-number-of-non-overlapping-palindrome-substrings/) **Difficulty:**
Hard **Pattern:** Greedy palindrome intervals **Tags:** Two Pointers, String, Dynamic Programming, Greedy

Choose the maximum number of non-overlapping palindromic substrings with length at least `k`.

Scan centers and greedily take the earliest-ending valid palindrome. Taking short earliest intervals leaves the most
