...
Suppose we have an array A[] of size N. After sorting, the element A[i] is mapped to index i. This way, elements that were in an arbitrary range are now mapped to the range [0, N-1] and yet their relative ordering is preserved. 
