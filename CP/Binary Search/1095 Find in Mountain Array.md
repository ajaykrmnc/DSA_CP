...
**LeetCode:** [1095. Find in Mountain Array](https://leetcode.com/problems/find-in-mountain-array/) **Difficulty:**
Hard **Pattern:** Interactive binary search **Tags:** Array, Binary Search, Interactive

## Problem

Find a target in a mountain array using limited indexed access.

## Approach

First binary search for the peak. Then binary search the increasing side and the decreasing side separately, adapting
comparisons for each slope.
...
public:
  int findInMountainArray(int target, MountainArray &mountainArr) {
    ...
    if (mountainArr.get(increasingIndex) == target) return increasingIndex; // Target found in the increasing part.
    ...
    if (mountainArr.get(decreasingIndex) == target) return decreasingIndex; // Target found in the decreasing part.
