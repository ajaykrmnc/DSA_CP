...
- **DAU:** Value: 800M
- **Daily video views:** Value: 4 Billion
- **Views/sec (avg / peak):** Value: 46K / 140K
- **Daily uploads:** Value: 500K videos
- **Daily new storage:** Value: ~175 TB
- **Daily egress bandwidth:** Value: ~448 PB
- **Peak egress:** Value: ~155 Tbps
- **CDN cache hit target:** Value: > 95%
- **Transcoding workers:** Value: ~20K concurrent
...
- **API Gateway:** Auth, rate limiting, request routing; Tech Stack: Kong / Envoy
- **Upload Service:** Chunked upload, checksum validation; Tech Stack: Go / Java
- **Video Processing Pipeline:** Transcoding, thumbnails, DRM, watermark; Tech Stack: FFmpeg + custom DAG
- **Streaming Service:** Manifest generation, segment serving; Tech Stack: Go / Rust
- **Search Service:** Full-text video search, autocomplete; Tech Stack: Elasticsearch
- **Recommendation Service:** Personalized feeds, related videos; Tech Stack: Python + ML models
- **User Service:** Registration, auth, profile management; Tech Stack: Java / Go
- **Comment Service:** CRUD comments, threading, moderation; Tech Stack: Java
- **Like Service:** Like/dislike toggle, aggregation; Tech Stack: Go
- **Subscription Service:** Subscribe/unsubscribe, feed fan-out; Tech Stack: Go
- **Notification Service:** Push notifications for new uploads; Tech Stack: Go + FCM/APNs
- **Content Moderation Service:** Automated policy checks, copyright detection; Tech Stack: Python + ML
- **CDN:** Edge caching, geo-distributed delivery; Tech Stack: CloudFront / Akamai
- **Object Storage:** Raw and processed video storage; Tech Stack: S3 / GCS
- **Message Queue:** Async pipeline orchestration; Tech Stack: Apache Kafka
...
- **240p:** Bitrate (H.264): 400 Kbps; Bitrate (H.265): 250 Kbps; Bitrate (AV1): 150 Kbps; Segment Size (6s): ~300 KB
- **360p:** Bitrate (H.264): 800 Kbps; Bitrate (H.265): 500 Kbps; Bitrate (AV1): 300 Kbps; Segment Size (6s): ~600 KB
- **480p:** Bitrate (H.264): 1.5 Mbps; Bitrate (H.265): 1.0 Mbps; Bitrate (AV1): 600 Kbps; Segment Size (6s): ~1.1 MB
- **720p:** Bitrate (H.264): 3.0 Mbps; Bitrate (H.265): 2.0 Mbps; Bitrate (AV1): 1.2 Mbps; Segment Size (6s): ~2.3 MB
- **1080p:** Bitrate (H.264): 5.0 Mbps; Bitrate (H.265): 3.5 Mbps; Bitrate (AV1): 2.0 Mbps; Segment Size (6s): ~3.8 MB
- **4K:** Bitrate (H.264): 15.0 Mbps; Bitrate (H.265): 10.0 Mbps; Bitrate (AV1): 6.0 Mbps; Segment Size (6s): ~11.3 MB
...
- **Developer:** HLS: Apple; DASH: MPEG consortium (open std)
- **Container format:** HLS: MPEG-TS (.ts) or fMP4; DASH: fMP4 (.m4s)
- **Manifest format:** HLS: .m3u8 (playlist); DASH: .mpd (XML)
- **Segment duration:** HLS: 6 seconds typical; DASH: 2-6 seconds
- **DRM support:** HLS: FairPlay; DASH: Widevine, PlayReady
- **Browser support:** HLS: Safari native, others MSE; DASH: All browsers via MSE
- **Latency:** HLS: 15-30 sec (standard); DASH: 3-10 sec (low latency)
- **Industry adoption:** HLS: Apple ecosystem, broad; DASH: YouTube, Netflix
...
- **Screen size:** Mobile: 5-7 inches; Desktop: 13-32 inches
- **Max useful res.:** Mobile: 720p (most), 1080p (flagship); Desktop: 1080p-4K
- **Network:** Mobile: Variable (4G/5G/WiFi); Desktop: Stable broadband
- **Battery:** Mobile: Limited, decode costs power; Desktop: Not a concern
- **Data caps:** Mobile: Common (2-50 GB/month); Desktop: Rare
