...
- **FR-1 - Browse events/movies by city, date:** Priority: P0
- **FR-2 - Search with filters (genre, language):** Priority: P0
- **FR-3 - View seat map with real-time status:** Priority: P0
- **FR-4 - Select seats and hold temporarily:** Priority: P0
- **FR-5 - Process payment and confirm booking:** Priority: P0
- **FR-6 - Booking cancellation and refund:** Priority: P0
- **FR-7 - Booking history and e-ticket:** Priority: P0
- **FR-8 - Notifications (confirmation, remind):** Priority: P1
- **FR-9 - Reviews and ratings for events:** Priority: P1
- **FR-10 - Dynamic pricing for high-demand shows:** Priority: P2
- **FR-11 - Group booking (10+ seats together):** Priority: P2
- **FR-12 - Waiting list for sold-out events:** Priority: P2
...
- **API Gateway:** Auth, rate limiting, request routing, SSL termination; Scaling Model: Horizontal, stateless
- **Event Service:** CRUD for events, venues, shows; schedule management; Scaling Model: Horizontal, read replicas
- **Booking Service:** Orchestrate hold → confirm → cancel flows; Scaling Model: Horizontal, stateless
- **Inventory Service:** Seat availability, holds, real-time updates; Scaling Model: Horizontal, Redis-backed
- **Payment Service:** Gateway integration, idempotent charges, refunds; Scaling Model: Horizontal, stateless
- **Search Service:** Full-text search, geo queries, facets, autocomplete; Scaling Model: Elasticsearch cluster
- **Notification Svc:** Email, SMS, push via Kafka consumers; Scaling Model: Horizontal, async
- **User Service:** Profile, auth, booking history; Scaling Model: Horizontal, read replicas
- **Queue/WaitRoom:** Flash sale traffic management, fair ordering; Scaling Model: Horizontal, Redis-backed
