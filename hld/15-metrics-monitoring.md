...
- **Prometheus:** Scale: Single-node TSDB, federation for scale; Approach: Pull-based, local storage
- **Datadog:** Scale: Billions of pts/sec across all tenants; Approach: Push-based, cloud SaaS
- **Thanos:** Scale: Long-term Prometheus with object store; Approach: Sidecar + compactor
- **Cortex/Mimir:** Scale: Multi-tenant horizontally-scaled Prom; Approach: Shared-nothing ingesters
- **InfluxDB:** Scale: Write-optimized columnar TSDB; Approach: Push, TSI index, TSM engine
- **VictoriaMetrics:** Scale: Optimized single/cluster TSDB; Approach: Pull/push, vmselect/vmstorage
