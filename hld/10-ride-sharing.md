...
- **Ride Service:** Trip lifecycle (CRUD), state machine; Tech Stack: Go/Java, PostgreSQL
- **Location Service:** Ingest driver GPS, geospatial queries; Tech Stack: Go, Redis GeoSet, Kafka
- **Matching Service:** Find best driver, dispatch, handle retries; Tech Stack: Go/Java, in-memory ranking
- **Pricing Service:** Fare calculation, surge multiplier, estimates; Tech Stack: Python/Go, Redis
- **Payment Service:** Authorization, capture, refund, driver payout; Tech Stack: Java, PostgreSQL, Stripe
- **ETA Service:** Time estimate using road network + traffic; Tech Stack: Go, Maps API, ML models
- **Route Service:** Path computation, turn-by-turn directions; Tech Stack: Go, OSRM / Google Maps
- **Notification Svc:** Push notifications, SMS, in-app messages; Tech Stack: Go, FCM/APNs, Twilio
- **Rating Service:** Store ratings, update averages; Tech Stack: Go, PostgreSQL
- **Analytics Service:** Real-time dashboards, supply-demand heatmaps; Tech Stack: Spark, Flink, Elasticsearch
