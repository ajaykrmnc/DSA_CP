...
- **Delivery latency:** <1s urgent, <5s high, <30s normal; Rationale: User expectation by priority
- **Availability:** 99.99% (52 min downtime/year); Rationale: Notifications are business-critical
- **Throughput:** 1B notifications/day, 50K/sec peak; Rationale: Scale for large user base
- **Delivery guarantee:** At-least-once; Rationale: Missed notification > duplicate
- **Deduplication:** Within 5-minute window; Rationale: Prevent spam from retries
- **Data retention:** 90 days hot, 1 year cold; Rationale: Analytics and audit trail
- **Global distribution:** Multi-region deployment; Rationale: Low latency worldwide
- **Provider failover:** <30s switchover; Rationale: No single provider dependency
