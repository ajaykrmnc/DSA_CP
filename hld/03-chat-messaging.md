...
- **1 - Send and receive 1-on-1 text messages in real-time:** Priority: P0
- **2 - Group chat with up to 256 members:** Priority: P0
- **3 - Message ordering within a conversation:** Priority: P0
- **4 - Delivery receipts: sent / delivered / read:** Priority: P0
- **5 - Push notifications for offline users:** Priority: P0
- **6 - Message history and scroll-back:** Priority: P0
- **7 - Media sharing (images, video, files up to 100MB):** Priority: P1
- **8 - Online / offline / last-seen presence:** Priority: P1
- **9 - End-to-end encryption:** Priority: P1
- **10 - Multi-device sync (phone, tablet, web):** Priority: P1
- **11 - Message search across conversations:** Priority: P2
- **12 - Message deletion (for me / for everyone):** Priority: P2
- **13 - Typing indicators:** Priority: P2
- **14 - Message reactions (emoji):** Priority: P3
...
- **Latency:** < 100ms message delivery (same region); Rationale: Real-time conversation feel
- **Availability:** 99.99% (52 min downtime/year); Rationale: Critical communication service
- **Durability:** 99.9999% (no message loss); Rationale: Users expect zero data loss
- **Throughput:** 230K+ messages/sec sustained; Rationale: 500M DAU, 40 msgs/user/day
- **Consistency:** Causal ordering within conversation; Rationale: Messages must appear in order
- **Presence:** Eventual consistency (< 10s lag); Rationale: Acceptable for online status
- **Scalability:** Support 2B registered, 500M DAU; Rationale: WhatsApp-scale
- **Message size:** Up to 64KB text, 100MB media; Rationale: Support rich content
- **Connection scale:** 500M concurrent WebSocket connections; Rationale: One per active user
- **Security:** End-to-end encryption for all messages; Rationale: Privacy requirement
...
- **Messages:** Daily: 20 Billion; Yearly: 7.3T
- **Message storage:** Daily: 20 TB; Yearly: 7.3 PB
- **Media storage:** Daily: 2.2 PB; Yearly: 800 PB
- **Fan-out deliveries:** Daily: 120 Billion; Yearly: 43.8T
- **WebSocket connections:** Daily: 500M peak; Yearly: -
- **Connection servers:** Daily: 5,000; Yearly: -
